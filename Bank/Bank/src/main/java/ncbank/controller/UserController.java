...
public class UserController {
	...
	public String login_pro(@Valid @ModelAttribute("tempLoginBean") UserBean tempLoginBean, Model model, BindingResult result) {
		...
		System.out.println("UserController - login_pro: " + loginUserBean.getUser_num());
	...
	public String join_pro(@Valid @ModelAttribute("mBean") UserBean mBean, BindingResult memberResult) {
		...
		/*
		 * 오류 검사할  쓰기 System.out.println(memberResult.hasErrors() + " " +
