					...
					<div class="card-body">
						...
						<form:form action="${root}/user/join_pro" method="post"
							...
							<div class="form-group">
								...
								<form:input path="resident" placeholder="주민번호 입력('-'까지 입력해주세요)" class='form-control' /> 
							...
							<div class="form-group">
								...
								<div class="input-group">
									<form:input path="id" class='form-control' placeholder="아이디" onkeypress="resetUserIdExist()" />
							...
							<div class="form-group">
								...
								<form:password path="pwd2" placeholder="비밀번호 확인"  class='form-control' />
								<form:errors path='pwd2' style='color:red' />
							</div>

							<div class="form-group">
								<form:label path="address">주소</form:label>
								<form:input path="address" placeholder="주소를 입력하세요." class='form-control' />
							</div>
							<div class="form-group">
								<form:label path="phone">전화번호</form:label>
								<form:input path="phone" placeholder="전화번호 ('-'까지 입력해주세요)" class='form-control' />
								<div class="input-group-append">
								        <button type="button" class="btn btn-primary" onclick="sendSMSVerification()">SMS 인증</button>
								    </div>
							...
							<div class="form-group">
								...
								<form:input path="email" type="email" placeholder="(선택)이메일" class='form-control' />
							</div>
							<div class="form-group">
