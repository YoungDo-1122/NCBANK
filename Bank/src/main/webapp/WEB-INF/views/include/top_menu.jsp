<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/teststyle_main.css">

        <nav class="navbar navbar-expand-md bg-primary  navbar-dark fixed-top shadow-lg">
            <!-- bg-primary : 파란색 -->
            <a class="navbar-brand" href="${root}main"> <img src="${root}img/ncbank_logo.png" style="height: 100px" />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop">조회 및
                            이체</a>
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="${root}account/transferAuto">자동
                                이체 등록</a> <a class="dropdown-item" href="${root}account/transferAutoFix">자동 이체 수정</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop"> 모임통장
                        </a>
                        <div class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="${root}exchange/rateInquiry" id="navbardrop"> 환전 </a>
                        <div class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop"> 게시판 </a>
                        <div class="dropdown-menu">
