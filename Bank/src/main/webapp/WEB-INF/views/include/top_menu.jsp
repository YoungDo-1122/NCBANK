...
<nav
   ...
   <a class="navbar-brand" href="${root}/main"> <img
      src="${root}/img/ncbank_logo.png" style="height: 100px" />
   </a>
   ...
   <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav">
         ...
         <a class="nav-link dropdown-toggle" href="${root}exchange/rateInquiry" id="navbardrop"> 환전 </a>
            <div class="dropdown-menu">
               <a class="dropdown-item" href="${root}exchange/rateInquiry">환율</a> <a
                  class="dropdown-item" href="${root}exchange/notice">환율알림</a> <a
                  class="dropdown-item" href="${root}exchange/notice">환전3</a> <a
