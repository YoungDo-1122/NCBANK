<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/teststyle_bottom.css">
        <script>
        ...
        <footer>
            ...
            <div class="bottom_bar">
                ...
                <div class="info">
                    ...
                    <div class="sns">
                        <a href="www.youtube.com"><img src="img/youtube5050.png" alt="youtube"></a>
                        <a href="www.instagram.com"><img src="img/instagram5050.png" alt="instagram"></a>
                        <a href="www.facebook.com"><img src="img/facebook5050.png" alt="facebook"></a>
                    </div>
                </div>
            </div>
        </footer>