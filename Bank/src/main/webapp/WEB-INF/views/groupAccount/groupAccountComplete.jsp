...
<body>
  <div class="main">
   <c:import url="/WEB-INF/views/include/top_menu.jsp" />
    ...
    <div class="info">
      <span>모임장 연결계좌: ${ac_name}${accounts}</span>
      <span>모임통장 계좌번호: ${accountInfo.to_account}</span>
      <span>회비 정보: ${accountInfo.auto_type} / ${accountInfo.auto_next_date} / ${accountInfo.auto_balance} 원</span>
