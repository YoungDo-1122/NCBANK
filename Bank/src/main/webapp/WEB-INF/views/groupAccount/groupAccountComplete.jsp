...
<script>
    ...
    window.onload = function() {
        ...
        console.log("Before formatting: ", autoTypeElement.textContent, autoNextDateElement.textContent, autoMoneyElement.textContent);

        var originalAutoType = autoTypeElement.textContent;

        // 포맷된 값을 설정합니다
        autoTypeElement.textContent = formatAutoType(originalAutoType);
        autoNextDateElement.textContent = formatAutoNextDate(originalAutoType, autoNextDateElement.textContent);
        autoMoneyElement.textContent = formatMoney(autoMoneyElement.textContent);

        console.log("After formatting: ", autoTypeElement.textContent, autoNextDateElement.textContent, autoMoneyElement.textContent);
    }
</script>
</head>
<body>
