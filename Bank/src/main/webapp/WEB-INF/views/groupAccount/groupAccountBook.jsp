						...
						$
								.ajax({
																...
																.each(
																		...
																		function(
																			...
																			transfersHtml += '<tr>'
																					...
																					+ '</td>'
																					+ '<td>'
																					+ formatTransferDate(transfer.trans_date)
																					+ '</td>'
																					+ '<td>'
																					+ (transfer.trans_type == 2 ? '출금'
																							: '입금')
																					+ '</td>'
																					+ '<td>'
																					+ transfer.trans_money
																					+ '</td>'
																					+ '<td>'
																					+ transfer.trans_balance
																					+ '</td>'
																					+ '<td>'
																					+ (transfer.trans_text ? transfer.trans_text
																							: '')
																					+ '</td>'
																					+ '</tr>';
																		});
									...
									error : function(err) {
										console
												.log(
														'Error fetching member details info:',
														err);
									},
								});
					},
...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2">
				<div class="menu1">
					<a href="${root}groupAccount/management">모임통장 정보</a> <a
						href="${root}groupAccount/members">모임원 관리</a>
