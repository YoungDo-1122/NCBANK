...
<body>
	...
	<div class="container mt-5">
		...
		<div class="form-group">
			<label for="content_subject">작성날짜</label>
			<input type="text" id="content_date" name="content_date" class="form-control" value="${readContentBean.content_date}" disabled="disabled"/>
		</div>
		<div class="form-group">
			<label for="content_subject">내용</label>
			<input type="text" id="board_content" name="board_content" class="form-control" value="${readContentBean.content_text}" disabled="disabled"/>
		</div>
