                    ...
                    <div class="mainhome">
                        <div class="carousel-wrapper">
                            <div class="carousel">
                                ...
                                <img src="img/Bank1.png" alt="캐러셀 이미지 1" class="active"> <img src="img/Bank2.png"
                                    alt="캐러셀 이미지 2"> <img src="img/Bank3.jpg" alt="캐러셀 이미지 3">
                        ...
                        <div class="bottom_menu">
                            <div class="tabMenu">
                                <input type="radio" id="tab1" name="tabs" checked> <label for="tab1">공지사항</label> <input
                                    type="radio" id="tab2" name="tabs">
                                ...
                                <div id="tab1Content" class="tabContent">
                                    ...
                                    <ul>
                                        <c:forEach var='obj' items="${list[0]}">
                                            <li><a
                                                    href="${root}board/read?board_info_idx=${board_list[0].board_info_idx}&content_idx=${obj.content_idx}&page=1">${obj.content_subject}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </div>
                                <div id="tab2Content" class="tabContent">
                                    <ul>
                                        <c:forEach var='obj' items="${list[1]}">
                                            <li><a
                                                    href="${root}board/read?board_info_idx=${board_list[1].board_info_idx}&content_idx=${obj.content_idx}&page=1">${obj.content_subject}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </div>
