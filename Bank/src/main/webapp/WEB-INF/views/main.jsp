...
<style>
<c:import url="/resources/css/style.jsp" />
</style>
...
<div class="container">
      <div class="carousel-wrapper">
        <div class="carousel">
            ...
            <img src="img/Bank1.png" alt="캐러셀 이미지 1" class="active">
            <img src="img/NCBank2.png" alt="캐러셀 이미지 2">
            <img src="img/NCBank2.jpe" alt="캐러셀 이미지 3">
        ...
        <div class="quickLink">
          <ul>
            <li>
              <a href="#">
                <img src="resources/img/NCBank2.png" alt="빠른링크1">
                <p>조회</p>
              </a>
            </li>
            <li>
              <a href="#">
                <img src="img/NCBank2.png" alt="빠른링크2">
                <p>이체</p>
              </a>
            </li>
            <li>
              <a href="#">
                <img src="/img/NCBank2.png" alt="빠른링크3">
                <p>환율</p>
              </a>
            </li>
          </ul>
    ...
    <div class="content">
      ...
      <div class="exchange_rate">
        ...
        <img id="currencyImage" src="/img/NCBank2.png" alt="통화 이미지">
      </div>
    </div>
