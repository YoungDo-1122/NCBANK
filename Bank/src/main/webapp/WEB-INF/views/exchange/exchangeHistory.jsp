...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/exchangeHistory.css">
<script
						...
						<ul class="pagination justify-content-center">
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a
										href="${root}exchange/exchangeHistory?user_num=${user_num}&page=${pageBean.prevPage}"
										class="page-link">이전</a></li>
								</c:otherwise>
							</c:choose>
							<c:forEach var="idx" begin="${pageBean.min}"
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a
											href="${root}exchange/exchangeHistory?user_num=${user_num}&page=${idx}"
											class="page-link">${idx}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a
										href="${root}exchange/exchangeHistory?user_num=${user_num}&page=${pageBean.nextPage}"
										class="page-link">다음</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
