...
<script>function formatAccountNumber(accountNumber) {
		...
		<div class="contentWarpASK">
			<div class="LP">
				...
				<div class="main-content">
					...
					<form:form action="${root}exchange/exchangeAskSuccess"
						method="post" modelAttribute="createExchangeBean">
						...
						<div class="form-group-exchange">
							...
							<div class="input-group-exchange">
								...
								<form:input type="number" path="trade_money"
									class="form-control" id="trade_money_input"
									onkeyup="getExchangeMoney(); hideExchangeTable();" />
						...
						<form:hidden path="exchange_payMoney"
							id="hidden_exchange_payMoney" />
						<form:hidden path="exchange_cash_buying_rate"
							id="hidden_exchange_cash_buying_rate" />
						<form:hidden path="trade_rate" id="hidden_trade_rate" />
						<form:hidden path="preferential_money"
							id="hidden_preferential_money" />
						...
						<div class="form-group-account">
							...
							<form:select path="account" id="account">
								<c:forEach var="accountItem" items="${getAccountList}">
									<form:option value="${accountItem.account}">
										<script>
													document
															.write(formatAccountNumber("[NC뱅크]&nbsp;${accountItem.account}"));
												</script>
									</form:option>
								</c:forEach>
							</form:select>
						...
						<div class="form-group-search">
							...
							<div class="input-group-search">
								...
								<button type="button" id="searchAddrBtn"
									class="btn btn-secondary" onclick="searchBank()">조회</button>
							</div>
						</div>
						...
						<div class="form-group-date">
							...
							<form:input path="trade_reservation_date" type="date"
								class="form-control" id="trade_reservation_date" />
						</div>
