...
<body>
	<div id="b101985">
		<h3 class="tit_dep2 tit_dep2_cont">환율알림서비스란?</h3>
		<ul class="list_type1">
			<li>일정 기간 내에 고객님께서 등록하신 환율범위 내로 환율이 도달하는 경우, 문자메시지 또는 이메일로 고객님께
				안내 드리는 서비스입니다.</li>
		</ul>
		<h3 class="tit_dep2 tit_dep2_cont s6">신청안내</h3>
		<ul class="list_type1">
